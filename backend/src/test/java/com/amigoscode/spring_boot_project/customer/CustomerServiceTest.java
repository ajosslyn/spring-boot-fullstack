...
class CustomerServiceTest {
    ...
    @Test
    void willThrowExceptionWhenTryingToUpdateDuplicateCustomerEmail() {
        // Given
        int id = 10;
        Customer customer = new Customer(
                id, "Alex", "alex@gmail.com", 19
        ...
        assertThatThrownBy(() -> underTest.updateCustomer(id, updateRequest))
                ...
                .hasMessage("email [alexandro@amigoscode.com] is taken");
    ...
    @Test
    void willThrowExceptionWhenDeleteCustomerByIdNotExists() {
        // Given
        int id = 10;
    ...
    void willThrowWhenCustomerUpdateHasNoChanges() {
        ...
        assertThatThrownBy(() -> underTest.updateCustomer(id, updateRequest))
                ...
                .hasMessage("No information change");
